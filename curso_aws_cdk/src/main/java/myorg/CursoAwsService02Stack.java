...
public class CursoAwsService02Stack extends Stack {
    public CursoAwsService02Stack(final Construct scope, final String id, Cluster cluster, SnsTopic productEventsTopic, Table productEventsDdb) {
        this(scope, id, null, cluster, productEventsTopic,productEventsDdb);
    }

    public CursoAwsService02Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic, Table productEventsDdb) {
        super(scope, id, props);

        Queue productsEventsDlq = Queue.Builder.create(this, "ProductEventsDlq")
                .queueName("products-events-dlq")
                .build();

        DeadLetterQueue deadLetterQueue = DeadLetterQueue.builder()
                .queue(productsEventsDlq)
                .maxReceiveCount(3)
                .build();
        ...
        envVariables.put("AWS_SQS_QUEUE_PRODUCT_EVENTS_NAME", productsEventsDlq.getQueueName());
        ...
        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("hpchugo/aws_project02:1.5.0"))
                                .containerPort(9090)
